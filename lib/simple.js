	...
	let fsizedoc = '1'.repeat(10)    
     ...
     if (buffer) try { (type = await conn.getFile(buffer), buffer = type.data) } catch { buffer = buffer }
          ...
          forwardedNewsletterMessageInfo: {
            newsletterJid: '120363315182357745@newsletter',
            newsletterName: '┋ᴍɪᴅᴏ ʙᴏᴛ┋', 
            serverMessageId: '' }, 
                ...options
                }
                })
...
let canalId = ["120363315182357745@newsletter", "120363315182357745@newsletter", "120363315182357745@newsletter", "120363315182357745@newsletter","120363315182357745@newsletter","120363315182357745@newsletter",]
let canalNombre = ["•❬ ᴍɪᴅᴏ ʙᴏᴛ❭•", "↓ ᴍɪᴅᴏ ʙᴏᴛ ↓", "ᵀᴬᴿᴮᴼᴼ ᴮᴼᵀ ᵂᴴᴬᵀˢᴬᴾᴾ", "┋ᴍɪᴅᴏ ʙᴏᴛ┋","MIDO ᗷOT ᗯᕼᗩTᔕᗩᑭᑭ","ᴍɪᴅᴏ 𝙱𝙾𝚃 𝚆𝙷𝙰𝚃𝚂𝙰𝙿𝙿"]
