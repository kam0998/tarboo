	...
	let fsizedoc = '1'.repeat(10)    
     ...
     if (buffer) try { (type = await conn.getFile(buffer), buffer = type.data) } catch { buffer = buffer }
          ...
          forwardedNewsletterMessageInfo: {
            newsletterJid: '120363297544336004@newsletter',
            newsletterName: '┋MIDO BOT┋', 
            serverMessageId: '' }, 
                ...options
                }
                })
...
let canalId = ["120363297544336004@newsletter", "120363297544336004@newsletter", "120363297544336004@newsletter", "120363297544336004@newsletter","120363297544336004@newsletter","120363297544336004@newsletter",]
let canalNombre = ["•❬ 𝒔𝒖𝒑𝒑𝒐𝒓𝒕 MIDO 𝒃𝒐𝒕 ❭•", "↓ MIDO 𝑈𝑃𝐷𝐴𝑇𝐸 ↓", "ᵀᴬᴿᴮᴼᴼ ᴮᴼᵀ ᵂᴴᴬᵀˢᴬᴾᴾ", "┋MIDO 𝐁𝐎𝐓┋","TᗩᖇᗷOO ᗷOT ᗯᕼᗩTᔕᗩᑭᑭ","𝚃𝙰𝚁𝙱𝙾𝙾 𝙱𝙾𝚃 𝚆𝙷𝙰𝚃𝚂𝙰𝙿𝙿"]
